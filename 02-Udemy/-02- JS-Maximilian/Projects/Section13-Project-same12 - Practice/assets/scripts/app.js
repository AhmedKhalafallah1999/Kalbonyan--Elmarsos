...
class Tooltip extends Component {
  ...
  show() {
    ...
    const hostElPosHeight = this.hostElementId.clientHeight;
...
class App {
  static init() {
    ...
    // document
    //   .getElementById("start-analytics")
    //   .addEventListener("click", this.analytical);
    setTimeout(this.analytical, 3000);
  }
  static analytical() {
    const scriptAnalytics = document.createElement("script");
    scriptAnalytics.src = "assets/scripts/analytics.js";
    scriptAnalytics.defer = true;
    document.head.append(scriptAnalytics);
  }
}
App.init();
